...
//    echo '<img src="http://junto.link/pictures/google.png" width="30" height="30" style="position:absolute;left:235px;margin-top:17px">';
    ...
    echo '<img style="position:relative;top:10px;" src="/pictures/save.png"  width="40" height="40" class="saving-icon">';
    ...
    $favorited = $conn->query($query);
      if($favorited->num_rows == 0){
                   ...
                   echo '<img style="position:relative;top:10px;" src="/pictures/cross-red.png"  width="40" height="40" class="saving-icon">';
           }
