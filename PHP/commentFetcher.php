...
if(isset($_COOKIE['junto']) && $_COOKIE['junto']==$author){echo '<img style="position:absolute;display:block;right:0px;" alt="delete" src="pictures/cross-red.png" width="15" height="15" onclick="deleteComment(';$outComment['COMMENTID'];echo')">';}
